...
from ..utilities.args import natural, directory, file, eqsign_kvpairs, backend_device, backend_devices
...
def main() -> int:
    ...
    parser.add_argument("-z", "--device", type=backend_device, choices=backend_devices)
    ...
    trained_model, exit_code = train(model, args.train, args.valid, args.test, dest, max_epoch=args.epoch, profile=args.profile, device=args.device)
