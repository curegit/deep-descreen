...
if __name__ == "__main__":
    try:
        ...
        prog = "python3 -m descreening.make"
    ...
    for i in rich.progress.track(range(n_samples), description="progress"):
        ...
        with TemporaryDirectory() as dirname:
            ...
            # ハーフトーン化
            array, y = halftone_rgb_image_to_wide_gamut_uint16_array(png_path, cmyk_icc, pitch, angles, perceptual=True, truth_pair=True)
            # 真ん中で切り出し
            ...
            #    #    continue
            save_array(build_filepath(dest_dir, f"{pitch:.14f}", "npy"), np.array([array, y]))
